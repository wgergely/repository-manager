...
///
/// Network operations (push, pull, merge) are provided as free functions
/// in the `helpers` module. They accept a `&Repository` and optional
/// layout-specific parameters rather than being part of the trait,
/// since their logic is identical across layouts.
